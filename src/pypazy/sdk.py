...
import httpx
from pypazy._hooks import SDKHooks
from pypazy.datasets import Datasets
from pypazy.literature import Literature
from pypazy.models import components
from pypazy.organisms import Organisms
from pypazy.proteins import Proteins
from pypazy.substrates import Substrates
from pypazy.types import OptionalNullable, UNSET
...
class Pazy(BaseSDK):
    ...
    def __init__(
        self,
        security: Union[components.Security, Callable[[], components.Security]],
