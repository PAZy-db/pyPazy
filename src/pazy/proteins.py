...
class Proteins:
    ...
    def get_protein_sequences(self) -> operations.GetProteinSequencesResponse:
        ...
        res = operations.GetProteinSequencesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def add_protein_sequence(self, request: components.ProteinSequenceInput) -> operations.AddProteinSequenceResponse:
        ...
        res = operations.AddProteinSequenceResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_protein_sequence_by_id(self, id: str) -> operations.GetProteinSequenceByIDResponse:
        ...
        res = operations.GetProteinSequenceByIDResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def update_protein_sequence(self, id: str, protein_sequence: components.ProteinSequenceInput) -> operations.UpdateProteinSequenceResponse:
        ...
        res = operations.UpdateProteinSequenceResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def partial_update_protein_sequence(self, id: str, patched_protein_sequence: Optional[components.PatchedProteinSequence] = None) -> operations.PartialUpdateProteinSequenceResponse:
        ...
        res = operations.PartialUpdateProteinSequenceResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def delete_protein_sequence(self, id: str) -> operations.DeleteProteinSequenceResponse:
        ...
        res = operations.DeleteProteinSequenceResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
